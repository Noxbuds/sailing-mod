...
import com.noxbuds.sailing.registry.ModItems;
...
public class SailingMod
{
    ...
    public static final RegistryObject<CreativeModeTab> SAILING_TAB = CREATIVE_MODE_TABS.register("sailing_tab", () -> CreativeModeTab.builder()
